...
import { ELFDynamicLinkerSymbol } from "./ELFDynamicLinkerSymbol";
...
export class ELFDynamicLinkerSymbolTableSection implements IELFSection
{
    private _symbols : ELFDynamicLinkerSymbol[];
    ...
    constructor(elfFile: ELFFile, binarySectionData: Buffer)
    {
        ...
        {
            this._symbols.push(new ELFDynamicLinkerSymbol(binarySectionData.subarray(currentOffset, currentOffset + SYMBOL_ENTRY_LENGTH), elfFile));
